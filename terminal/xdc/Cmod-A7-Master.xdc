...
## set_false_path -from [get_clocks clk3728] -to [get_clocks clk2500]
## set_false_path -from [get_clocks clk2500_clk_dual] -to [get_clocks clk3728_clk_dual]
## set_false_path -from [get_clocks clk3728_clk_dual] -to [get_clocks clk2500_clk_dual]
...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { RsTx  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01] out to SIO
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { RsRx  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02] in from SIO
...
# PIO12 is connected to on-board oscillator if needed
...
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { kb_data }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
#set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { pio26 }]; #IO_L2P_T0_34 Sch=pio[26]
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { Hsync }]; #IO_L2N_T0_34 Sch=pio[27]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { Vsync }]; #IO_L1P_T0_34 Sch=pio[28]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[0] }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[1] }]; #IO_L1N_T0_34 Sch=pio[30]
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[2] }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[3] }]; #IO_L5N_T0_34 Sch=pio[32]
...
set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports { vgaGreen[0] }]; #IO_L6P_T0_34 Sch=pio[35]
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { vgaGreen[1] }]; #IO_L12P_T1_MRCC_34 Sch=pio[36]
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { vgaGreen[2] }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_property -dict { PACKAGE_PIN U4    IOSTANDARD LVCMOS33 } [get_ports { vgaGreen[3] }]; #IO_L11P_T1_SRCC_34 Sch=pio[38]
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { vgaBlue[0] }]; #IO_L16P_T2_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { vgaBlue[1] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { vgaBlue[2] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { vgaBlue[3] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
